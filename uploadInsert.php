<?php
	...
	foreach($data as $row){
		...
		$sql = "INSERT INTO stores (Store_id, Name, Address,lat,lng,Rating,RatingN,Types) VALUES ('".$row['id']."', '".$row['name']."', '".$row['address']."','".$row['lat']."','".$row['lng']."', '".$row['rating']."', '".$row['rating_n']."','".$row['types']."')";
